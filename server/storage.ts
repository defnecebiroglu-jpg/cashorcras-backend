  ...
  private initializeData() {
    ...
    const initialTeams: InsertTeam[] = [
      ...
      },
      {
        name: "20. Takım",
        cashBalance: "100000.00",
        accessCode: "ENFLASYON200",
        profilePicUrl: null,
      },
      {
        name: "21. Takım",
        cashBalance: "100000.00",
        accessCode: "RISKBUDUR1",
        profilePicUrl: null,
      },
      {
        name: "22. Takım",
      ...
      },
      {
        name: "29. Takım",
        cashBalance: "100000.00",
        accessCode: "BIZNIZPOZITIF6",
        profilePicUrl: null,
      },
      {
        name: "30. Takım",
        cashBalance: "100000.00",
        accessCode: "BORSISAYISALCI",
        profilePicUrl: null,
      },
      {
        name: "Yedek Takım 1",
