...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post('/api/admin/distribute-dividend/:companyId', checkAdmin, async (req, res) => {
    try {
  ...
  app.post('/api/admin/assign-stock', checkAdmin, async (req, res) => {
    try {
  ...
  app.post('/api/admin/unassign-stock', checkAdmin, async (req, res) => {
    try {
      const { teamId, companyId, shares } = req.body;
  ...
  app.post('/api/admin/assign-currency', checkAdmin, async (req, res) => {
    try {
  ...
  app.post('/api/admin/unassign-currency', checkAdmin, async (req, res) => {
    try {
      const { teamId, currencyId, amount } = req.body;
  ...
  app.put('/api/admin/update-team-password', checkAdmin, async (req, res) => {
    try {
  ...
  app.put('/api/admin/update-admin-password', checkAdmin, async (req, res) => {
    try {
  ...
  app.put('/api/admin/update-team-name', checkAdmin, async (req, res) => {
    try {
  ...
  app.post('/api/companies', checkAdmin, upload.single('logo'), async (req, res) => {
    try {
  ...
  app.put('/api/companies/:id', checkAdmin, upload.single('logo'), async (req, res) => {
    try {
      const data = { ...req.body };
      if (req.file) {
        data.logoUrl = `/uploads/${req.file.filename}`;
  ...
  app.delete('/api/companies/:id', checkAdmin, async (req, res) => {
    try {
  ...
  app.patch('/api/companies/:id', checkAdmin, async (req, res) => {
    try {
  ...
  app.post('/api/currencies', checkAdmin, upload.single('logo'), async (req, res) => {
    try {
  ...
  app.put('/api/currencies/:id', checkAdmin, upload.single('logo'), async (req, res) => {
    try {
      const data = { ...req.body };
      if (req.file) {
        data.logoUrl = `/uploads/${req.file.filename}`;
  ...
  app.delete('/api/currencies/:id', checkAdmin, async (req, res) => {
    try {
  ...
  app.patch('/api/currencies/:id', checkAdmin, async (req, res) => {
    try {
  ...
  app.post('/api/teams', checkAdmin, async (req, res) => {
    try {
  ...
  app.put('/api/teams/:id', checkAdmin, upload.single('profilePic'), async (req, res) => {
    try {
      const data = { ...req.body };
      if (req.file) {
  ...
  app.patch('/api/teams/:id', checkAdmin, async (req, res) => {
    try {
  ...
  app.delete('/api/teams/:id', checkAdmin, async (req, res) => {
    try {
  ...
  // Team Stocks
  app.post('/api/team-stocks', checkAdmin, async (req, res) => {
    try {
  ...
  app.put('/api/team-stocks/:id', checkAdmin, async (req, res) => {
    try {
  ...
  app.delete('/api/team-stocks/:id', checkAdmin, async (req, res) => {
    try {
  ...
  // Team Currencies
  app.post('/api/team-currencies', checkAdmin, async (req, res) => {
    try {
  ...
  app.put('/api/team-currencies/:id', checkAdmin, async (req, res) => {
    try {
  ...
  app.delete('/api/team-currencies/:id', checkAdmin, async (req, res) => {
    try {
  ...
  // Team Startups
  app.post('/api/team-startups', checkAdmin, async (req, res) => {
    try {
  ...
  app.put('/api/team-startups/:id', checkAdmin, async (req, res) => {
    try {
  ...
  app.delete('/api/team-startups/:id', checkAdmin, async (req, res) => {
    try {
