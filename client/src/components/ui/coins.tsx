...
export function Coins() {
  const [coins, setCoins] = useState<Coin[]>(() => {
    ...
    return [
      { id: 1, x: 100, y: 100, size: 60, rotation: 0, selected: false },
      { id: 2, x: 200, y: 120, size: 60, rotation: 0, selected: false },
      { id: 3, x: 300, y: 140, size: 60, rotation: 0, selected: false },
      { id: 4, x: 100, y: 200, size: 60, rotation: 0, selected: false },
      { id: 5, x: 200, y: 220, size: 60, rotation: 0, selected: false },
      { id: 6, x: 300, y: 240, size: 60, rotation: 0, selected: false },
    ];
  });
